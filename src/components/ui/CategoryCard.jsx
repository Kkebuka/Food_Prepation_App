...
export default function CategoryCard({ name, image,rounded}) {
  return (
    <Link
      to={`/category/${name}`}
      className="group relative  w-full bg-base-100 rounded-full overflow-hidden transition-transform duration-300 hover:-translate-y-2"
    >
      {/* Image */}
